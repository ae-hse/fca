...
import fca
import fca.algorithms.exploration.ConflictExploration as ConflictExploration
...
class CommandLineExploration(ConflictExploration):
    def __init__(self):
        self.d = {
            "even" : lambda n: n % 2 == 0,
            "odd" : lambda n: n % 2 == 1,
        ...
        cxt = ConflictExploration(attributes=set(self.d.keys()))

        super(CommandLineExploration, self).__init__(cxt)
        self._session = self.create_session("A")
